...
export default function AttackCard({ icon, title, description, isDarkMode = false }) {
    return (
        <div className={`h-full p-7 md:p-8 rounded-2xl border shadow-sm hover:shadow-md transition-shadow min-h-[260px] ${isDarkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
